...
<div class="jumbotron text-center">
  <p>                                                      </p><br>
  <h3>Ici vous pouvez affecter l'absence a vos employés </h3> 
...
<div class="row">
    ...
    <div class="col-md-2">
      <ul class="nav nav-pills nav-stacked">
        <li ><a href="/gestionRH/acceuilconge.php">Acceuil</a></li>
			...
			<table class="table table-condensed">
					    ...
					    <tbody>
					      ...
					      <tr>
					        ...
					        <td><a href="addconge.php?id=${e.id }">ajouter un congé</a></td>
